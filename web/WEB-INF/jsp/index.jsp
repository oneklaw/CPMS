            ...
            <tr><td>
                ...
                <td>
                   Department:<select  name="Department">
                              <option value="audi">Screening </option>
                              <option value="audi"> Consultation</option>
                              <option value="audi">Laboratory </option>
                              <option value="audi"> Pharmacy</option>
                              <option value="audi">Paliative Care </option>
                                </select>
